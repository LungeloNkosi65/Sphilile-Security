...
namespace SphileSecurity.Controllers
{
    public class PackageTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PackageTypeId,PackageName,PackageDescription")] PackageType packageType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PackageTypeId,PackageName,PackageDescription")] PackageType packageType)
        {
            if (ModelState.IsValid)
            {
